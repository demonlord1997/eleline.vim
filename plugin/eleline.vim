...
function! s:StatusLine() abort
  ...
  let l:common = l:paste.l:curfname.l:branch.' '.l:status.l:error.l:warning.l:tags.l:lcn.l:coc
  return l:common.'%='.l:m_r_f.l:pos.l:fsize " .l:enc.l:ff.l:pct
endfunction
...
function! s:hi_statusline() abort
  ...
  call s:hi('ElelineFsize'      , [235 , 140] , [235 , ''] )
  call s:hi('ElelineCurFname'   , [232 , 178] , [171 , '']     , 'italic' )
...
function! s:InsertStatuslineColor(mode) abort
  if a:mode ==# 'i'
    call s:hi('ElelineCurFname' , [232, 178] , [251, 89])
  elseif a:mode ==# 'r'
    call s:hi('ElelineCurFname' , [232, 160], [232, 160])
  else
    call s:hi('ElelineCurFname' , [232, 140], [89, ''])
  endif
endfunction
